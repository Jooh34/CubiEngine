...
@REM xcopy External\DirectXShaderCompiler\bin\x64\* %BuildDirectory%\Bin\Release\
...
@REM xcopy External\DirectXShaderCompiler\lib\x64\* %BuildDirectory%\Bin\Debug\
@REM xcopy External\DirectXShaderCompiler\lib\x64\* %BuildDirectory%\Bin\Release\
