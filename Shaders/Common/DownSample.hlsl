...
void CsMain( uint3 dispatchThreadID : SV_DispatchThreadID)
{
    ...
    // // Fetch and average
    float4 c00 = srcTexture.Sample(pointClampSampler, srcCoord00);
    float4 c10 = srcTexture.Sample(pointClampSampler, srcCoord10);
    float4 c01 = srcTexture.Sample(pointClampSampler, srcCoord01);
    float4 c11 = srcTexture.Sample(pointClampSampler, srcCoord11);
